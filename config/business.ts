export const BUSINESS_NAME = process.env.NEXT_PUBLIC_BUSINESS_NAME ?? "ProTint Auto";
...
export const BUSINESS_EMAIL = process.env.NEXT_PUBLIC_BUSINESS_EMAIL ?? "info@protintauto.com";
...
export const SERVICES = [
  "Full Car Tint (All Windows)",
  "Front 2 Windows Only",
  "Rear Windows Only",
  "Windshield Protection Film",
  "SUV / Truck Full Package",
] as const;
