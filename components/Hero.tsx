...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-black via-[#0a0a0a] to-[#111827]" />
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto">
        <span className="inline-block mb-4 px-4 py-1.5 rounded-full border border-amber-600/40 bg-amber-600/10 text-amber-400 text-xs font-semibold uppercase tracking-widest">
        ...
        <h1 className="text-5xl sm:text-6xl md:text-7xl font-extrabold leading-tight tracking-tight">
          Protect Your Ride.{" "}
          <span className="text-amber-500">Elevate the Look.</span>
        </h1>

        <p className="mt-6 text-lg sm:text-xl text-zinc-400 max-w-2xl mx-auto leading-relaxed">
          Premium window tinting, detailing, PPF, and wraps for cars, trucks, and SUVs.
          Computer plotter-cut fit, ultimate heat rejection, and flawless finish.
        </p>

        <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/book"
            className="px-8 py-4 bg-amber-600 hover:bg-amber-500 text-white font-bold text-base rounded-lg transition-all shadow-lg shadow-amber-900/30 hover:scale-105"
          >
            Book an Appointment
          </Link>
          <a
