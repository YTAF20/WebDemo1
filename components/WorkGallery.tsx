...
export default function WorkGallery() {
  return (
    <section id="work" className="py-24 px-4 sm:px-6 bg-black/70">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {items.map((item) => (
            <div
              key={item.title}
              className="group relative overflow-hidden rounded-2xl border border-white/5 bg-[#111827] transition-all hover:border-red-600/30"
            >
              <div className="relative aspect-[4/3] w-full overflow-hidden">
                ...
                <span className="absolute top-4 left-4 text-[10px] font-bold tracking-wider uppercase bg-red-600/90 text-white px-2.5 py-1 rounded-md">
                  {item.tag}
                </span>
              </div>
              <div className="p-6">
        ...
        <div className="mt-16 text-center">
          <a
            ...
            className="inline-flex items-center gap-3 px-8 py-4 bg-zinc-900 hover:bg-zinc-800 border border-white/10 hover:border-red-600/30 text-white font-bold rounded-xl transition-all hover:-translate-y-0.5"
          >
            <svg
